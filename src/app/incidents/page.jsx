...
export default function IncidentsPage() {
  return (
    <div className="relative flex flex-col h-screen bg-black text-white">
      ...
      <div className="z-100 sticky top-0 backdrop-blur-md">
        <Navbar />
      </div>


      {/* Main section */}
      <div className="flex flex-1 overflow-hidden z-10 main-section">
        {/* Left Section: Video player */}
        <div className="w-3/5 p-4 space-y-4 overflow-y-auto video-player">
          <VideoPlayer />
        </div>

        {/* Right Section: Incident List */}
        <div className="w-2/5  bg-zinc-900 m-4 p-4 rounded-md overflow-y-auto incident-list">
          <IncidentList />
        </div>
      </div>
    </div>
